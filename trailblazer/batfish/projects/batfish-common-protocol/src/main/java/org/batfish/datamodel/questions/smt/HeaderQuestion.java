...
public class HeaderQuestion extends Question {
  ...
  private static final String PROP_FULL_LINK_PATH_VAR = "fullLinkPath";

  private static final String PROP_BEST_PATH_WITH_BROKEN_VAR = "bestPathWithBrokenEdges";

  private static final String PROP_DEPTH = "recursive_depth";
  ...
  private String _fullLinkPath;

  private String _bestPathWithBrokenEdges;
  ...
  public HeaderQuestion(HeaderQuestion q) {
    ...
    _fullLinkPath = q._fullLinkPath;
    _bestPathWithBrokenEdges = q._bestPathWithBrokenEdges;
    _depth = q._depth;
  }
  ...
  @JsonProperty(PROP_FULL_LINK_PATH_VAR)
  public String getFullLinkPath(){
    return _fullLinkPath;
  }

  @JsonProperty(PROP_BEST_PATH_WITH_BROKEN_VAR)
  public String getBestPathWithBrokenEdges(){
    return _bestPathWithBrokenEdges;
  }

  @JsonProperty(PROP_DEPTH)
  public int getDepth(){
    return _depth;
  }
  ...
  @JsonProperty(PROP_FULL_LINK_PATH_VAR)
  public void setFullLinkPath(String fullLinkPath){
    _fullLinkPath = fullLinkPath;
  }

  @JsonProperty(PROP_BEST_PATH_WITH_BROKEN_VAR)
  public void setBestPathWithBrokenEdges(String bestPathWithBrokenEdges){
    _bestPathWithBrokenEdges = bestPathWithBrokenEdges;
  }
