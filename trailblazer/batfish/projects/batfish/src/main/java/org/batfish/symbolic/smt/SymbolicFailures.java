...
//  private ArithExpr _zero;
  ...
  private BoolExpr _zero;

//  private Table2<String, String, ArithExpr> _failedInternalLinks;

  private Table2<String, String, BoolExpr> _failedInternalLinks;

//  private Map<GraphEdge, ArithExpr> _failedEdgeLinks;

  private Map<GraphEdge, BoolExpr> _failedEdgeLinks;
...
//  }
  ...
  Table2<String, String, BoolExpr> getFailedInternalLinks() {
    return _failedInternalLinks;
  }
...
//  }
  ...
  Map<GraphEdge, BoolExpr> getFailedEdgeLinks() {
    return _failedEdgeLinks;
  }
...
//  }
  ...
  @Nullable
  BoolExpr getFailedVariable(GraphEdge ge) {
    if (ge.isAbstract()) {
      return _zero;
    }
    if (ge.getPeer() == null) {
