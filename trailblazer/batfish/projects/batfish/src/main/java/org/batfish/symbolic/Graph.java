...
public class Graph {
  ...
  @Nullable public GraphEdge findEdge(String router, String neighbour){
//    for (GraphEdge e : _edgeMap.get(router)) {
//      System.out.println(e.getPeer());
//        if (e.getPeer().equals(neighbour)){
//          return  e;
//        }
//    }
    return _edgeMap.get(router).stream().filter(edge ->
        edge.getPeer() != null && edge.getPeer().equals(neighbour)).findFirst().orElse(null);
  }
